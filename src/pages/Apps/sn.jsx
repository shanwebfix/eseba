...
const AppDetails = () => {
  ...
  const appData = {
    ...
    description: "শমশেরনগর ই-সেবা অ্যাপটি তৈরি করা হয়েছে স্থানীয় জনগণের দুর্ভোগ কমাতে। এখানে আপনি ডাক্তার, রক্তদাতা, ফায়ার সার্ভিস এবং বিদ্যুৎ অফিসের সকল তথ্য এক জায়গায় পাবেন।",
    rating: 4.9,
    reviews: "4.2k",
    size: "6.1 MB",
    version: "1.0.2",
  ...
  const handleDownload = () => {
    ...
    link.href = '/app/Shamshernagar.apk';
    link.download = 'Shamshernagar.apk';
    link.click();
  };
